...
public class SolidObject // Applys to all objex who need collision detection
{
     ...
     public double sizeX,sizeY; // Size of collision HULL
     public void makeSolidObject(double pos_x, double pos_y, double size_x, double size_y) // Create new solid object
     {
          posX = pos_x;
          posY = pos_y;
          sizeX = size_x;
  ...
  // Create new solid object via a rectangle object
     public void makeSolidObject(Rectangle hitBox)
     {
          posX = hitBox.getX();
          posY = hitBox.getY();
          sizeX = hitBox.getWidth();
          sizeY = hitBox.getHeight();
     }
     
     public void compileHull()
     {
          // Compiles the hull into a Rectangle class for colliding
          collisionHull = new Rectangle((int)posX, (int)posY, (int)sizeX, (int)sizeY);
     }
     ...
     public boolean isColliding(@SuppressWarnings("rawtypes") ArrayList solidObjects)
     {
     ...
     public void move(double pos_x,double pos_y,@SuppressWarnings("rawtypes") ArrayList solidObjects)
     {
     ...
     public int getDirectionToSlideIn(SolidObject what,int direction)
     {
          ...
          switch(direction)
          {
               case 3: // MOVE DOWN
               case 1: // MOVE UP
               a = new Rectangle((int)posX, (int)posY, (int)sizeX/2, (int)sizeY);
               b = new Rectangle((int)(posX+sizeX/2), (int)posY, (int)sizeX/2, (int)sizeY);
               ...
               case 2: // MOVE RIGHT
               case 4: // MOVE LEFT
               a = new Rectangle((int)posX, (int)posY, (int)sizeX, (int)sizeY/2);
               b = new Rectangle((int)posX, (int)(posY+sizeY/2), (int)sizeX, (int)sizeY/2);
               if(!(isCollidingWith(a,what) && isCollidingWith(b,what)))
               {
                    if(isCollidingWith(a,what))
                         return 3;
